    ...
    for(i=0; i<code_offset; i++)
    {
        ...
        switch(code[i].op)
        {
            ...
            case IF_START:
                            ...
                            printf("\tcmp eax, 0\n");
                            {
                                char else_start_label[30]="ELSE_START_LABEL_";
                                char number[10];
                                snprintf(number, sizeof(number), "%d", code[i].arg);
                                strncat(else_start_label, number, sizeof(else_start_label) - strlen(else_start_label) - 1);
                                printf("\tjle %s\n", else_start_label);
                            }
                            printf("\n");
                            break;
            ...
            case ELSE_END:
                            {
                                char else_end_label[30]="ELSE_END_LABEL_";
                                char number[10];
                                snprintf(number, sizeof(number), "%d", code[i].arg);
                                strncat(else_end_label, number, sizeof(else_end_label) - strlen(else_end_label) - 1);
                                printf("%s:\n", else_end_label);
                            }
                            printf("\n");
                            break;
            case WHILE_LABEL:
                            {
                                char while_start_label[30] = "WHILE_START_LABEL_";
                                char number[10];
                                snprintf(number, sizeof(number), "%d", code[i].arg);
                                strncat(while_start_label, number, sizeof(while_start_label) - strlen(while_start_label) - 1);
                                printf("%s:\n", while_start_label);
                            }
                            printf("\n");
                            break;
            ...
            case WHILE_START:
                            ...
                            printf("\tcmp eax, 0\n");
                            {
                                char while_end_label[30]="WHILE_END_LABEL_";
                                char number[10];
                                snprintf(number, sizeof(number), "%d", code[i].arg);
                                strncat(while_end_label, number, sizeof(while_end_label) - strlen(while_end_label) - 1);
                                printf("\tjle %s\n", while_end_label);
                            }
                            printf("\n");
                            break;
